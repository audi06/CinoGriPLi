...
class cnextra(Poll, Converter, object):
    ...
    def __init__(self, type):
        ...
        self.caid_data = (('0x1700',
         ...
         ('0x4aee',
          ...
          'Bu',
          False))
        self.ca_table = (('CryptoCaidBetaAvailable', 'Be', False),
         ('CryptoCaidIrdetoAvailable', 'Ir', False),
         ('CryptoCaidSecaAvailable', 'Se', False),
         ('CryptoCaidViaAvailable', 'Vi', False),
         ...
         ('CryptoCaidBissAvailable', 'Bis', False),
         ('CryptoCaidPowerVUAvailable', 'Pw', False),
         ('CryptoCaidBulCrypt1Available', 'Bu', False),
         ('CryptoCaidBetaSelected', 'Be', True),
         ('CryptoCaidIrdetoSelected', 'Ir', True),
         ('CryptoCaidSecaSelected', 'Se', True),
         ('CryptoCaidViaSelected', 'Vi', True),
         ('CryptoCaidNagraSelected', 'Na', True),
         ...
         ('CryptoCaidBissSelected', 'Bis', True),
         ('CryptoCaidPowerVUSelected', 'Pw', True),
